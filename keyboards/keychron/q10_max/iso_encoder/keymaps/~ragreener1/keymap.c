...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTY_M_BASE] = LAYOUT_91_iso(
        ...
        MC_5,       KC_LCTL,  KC_LGUI,           KC_LALT, KC_SPC,  MO(QWERTY_M_FN),           KC_SPC,             KC_RALT,           KC_RCTL,            KC_LEFT,  KC_DOWN,  KC_RGHT),

    [QWERTY_M_FN] = LAYOUT_91_iso(
    ...
    [WIN_BASE_DH] = LAYOUT_91_iso(
        ...
        MC_3,LCTL_T(KC_ESC),  UK_A,     UK_R,     UK_S,     UK_T,     UK_G,      UK_M,     UK_N,     UK_E,     UK_I,     UK_O,     UK_QUOT,  UK_HASH,   KC_ENT,             KC_HOME,
        MC_4,       SC_LSPO,  UK_Z,     UK_X,     UK_C,     UK_D,     UK_V,   UK_BSLS,  UK_BSLS,     UK_K,     UK_H,     UK_COMM,   UK_DOT,  UK_SLSH,  SC_RSPC,     KC_UP,
        MC_5,       CW_TOGG,  KC_LWIN,            KC_LALT,  KC_SPC,  MO(WIN_FN),           KC_ENT,             KC_RALT,            KC_RCTL,            KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [WIN_FN] = LAYOUT_91_iso(
        ...
        _______,    KC_CAPS,  _______,            _______,  _______,  _______,             UK_0,            _______,            _______,             _______,  _______,  _______),
};

#if defined(ENCODER_MAP_ENABLE)
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [QWERTY_M_BASE] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [QWERTY_M_FN] = {ENCODER_CCW_CW(RGB_VAD, RGB_VAI)},
